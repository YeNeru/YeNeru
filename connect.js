...
Biiofc.autosw = true;
  Biiofc.public = true;
  Biiofc.sendsw = `6287840585294@s.whatsapp.net`;
...
Biiofc.ev.on('connection.update', async (update) => {
      ...
      if (connection === 'connecting') {
       ...
       console.log("[zans Botz Official] running")
     } else if (connection === 'open') {
         console.log(chalk.green(`Terhubung Ke WhatsApp Menggunakan PediaDev Official..`))
  //       Biiofc.sendMessage("6287761674503@s.whatsapp.net", {text:`${JSON.stringify(update, undefined, 2)}`})}


         Biiofc.sendMessage(Biiofc.sendsw, {
                text: `*Terhubung Menggunakan Script Bot WhatsApp ZansPiwV1🏅*`,
              });
